...
Key Facts
	•	Stats are always calculated for the rolling last 24 hours: starts, completions, focus time, and completion rate. 	•	In Flow mode you can extend focus by 5 minutes at cycle end; in Classic mode it continues with the selected preset.
How to Use (3 Steps)
